...
<h2 class="title"><?php echo $adminlang["SortPagesPageTitle"]; ?></h2>
<div class="main">
	<div class="infom"></div>
	<ul id="test-list" class="SayfalariSirala">
		<?php
			$dilkodu = session("SMLID");
			$sorgu = sorgula("SELECT PageID, PageTitle FROM pages WHERE PageStatus = 1 AND SubPageID = 0 AND LangID = '$dilkodu' ORDER BY PageOrder");
